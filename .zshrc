...
alias ibrew="arch -x86_64 /usr/local/bin/brew"
 ...
 alias updatelocaldotfiles="cp ./init.vim ~/.config/nvim/init.vim && cp ./.init.vim ~/.config/nvim/.init.vim && cp ./.zshrc ~/.zshrc && cp ./.tmux.conf ~/.tmux.conf && source ~/.zshrc"
 alias updateremotedotfiles="cp ~/.config/nvim/init.vim ./init.vim && cp ~/.config/nvim/.init.vim ./.init.vim && cp ~/.zshrc ./.zshrc && cp ~/.tmux.conf ./.tmux.conf"
